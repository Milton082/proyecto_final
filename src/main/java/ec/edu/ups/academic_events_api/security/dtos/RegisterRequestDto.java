...
public record RegisterRequestDto(
        ...
        @NotBlank(message = "El correo es obligatorio") @Email(message = "Debe ingresar un correo válido") @Size(max = 160, message = "El correo no puede superar 160 caracteres") String email,
